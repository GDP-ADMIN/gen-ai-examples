...
main() {
    ...
    log "${COLOR_INFO}Setting up gen-ai-internal-hello-world example...$COLOR_RESET"
    copy_env_file
    configure_poetry_python_path
    install_dependencies
    log "${COLOR_SUCCESS}gen-ai-internal-hello-world example ready to run.$COLOR_RESET"
