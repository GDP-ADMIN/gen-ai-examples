...
def sample_tool(query: str) -> str:
    ...
    or perform a specific calculation related to information_compiler_agent.
    ...
    return f"The InformationCompilerAgent Agent received your query: '{query}'. This is a sample tool response."
